...
public class MonsterEntity {
    ...
    public MonsterEntity(String name, String outfit, int tileX, int tileY, World world) {
        ...
        this.position = new Position(tileX * 32, tileY * 32);
        this.position.setDirection('s');
        this.velocity = new Velocity(2000, 2000);
        this.velocity.setDesiredX(tileX * 32);
        this.velocity.setDesiredY(tileY * 32);
        this.entity = world.createEntity();
        this.enemy = new Enemy();
        this.entity.addComponent(enemy);
